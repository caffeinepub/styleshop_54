...
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: OrderType): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getOrdersByEmail(arg0: string): Promise<Array<OrderType>> {
        if (this.processError) {
            try {
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_OrderType]): OrderType | null {
    return value.length === 0 ? null : value[0];
}
