...
export const idlService = IDL.Service({
  ...
  'claimAdminWithBackupCode' : IDL.Func([IDL.Text], [IDL.Bool], []),
  ...
  'getContactInfo' : IDL.Func(
      [],
      [IDL.Record({ 'whatsapp' : IDL.Text, 'email' : IDL.Text })],
      ['query'],
    ),
  'getMyOrders' : IDL.Func([], [IDL.Vec(OrderType)], ['query']),
  'getOrderById' : IDL.Func([IDL.Nat], [IDL.Opt(OrderType)], ['query']),
  'getOrderByIdAndPhone' : IDL.Func(
      [IDL.Nat, IDL.Text],
      [IDL.Opt(OrderType)],
      ['query'],
    ),
